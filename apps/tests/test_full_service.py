...
环境变量：
  GATEWAY_URL   默认读 config.json 的 gateway_port（http://localhost:8006）
  WORKER_URL    默认读 config.json 的 worker_base_port（http://localhost:22700）
"""
...
try:
    ...
    _default_gateway = "https://localhost:8006"
    _default_worker = "http://localhost:22700"
